...
function cost = computeRMS(parameters)
    ...
    set_param('NEW_KL3_NEW/VDS/Kmax', 'constant', num2str(Kmax)); 
    set_param('NEW_KL3_NEW/VDS/Kmin', 'constant', num2str(Kmin)); 
    set_param('NEW_KL3_NEW/KL3_damper', 'D', num2str(c)); 
    set_param('NEW_KL3_NEW/KL3_inerter', 'B', num2str(b));

    % Run the simulation
    simOut = sim('NEW_KL3_NEW.slx');
