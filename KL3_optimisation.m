...
function cost = computeRMS(parameters)
    ...
    set_param('NEW_KL3_NEW/VDS/KL3 Kmax', 'Gain', num2str(Kmax)); 
    set_param('NEW_KL3_NEW/VDS/KL3 Kmin', 'Gain', num2str(Kmin)); 
    set_param('NEW_KL3_NEW/KL3 (damper)', 'D', num2str(c)); 
    set_param('NEW_KL3_NEW/KL3 (inerter)', 'B', num2str(b));
